...
import { TrendingUp, BarChart3, Target, Shield, ArrowRight, ChevronRight, Check, Sparkles } from 'lucide-react';
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Pricing Section */}
      <section id="pricing" className="py-24 bg-muted/20 scroll-mt-20">
        <div className="container mx-auto px-6">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative p-6 rounded-2xl bg-card border border-border/50 flex flex-col"
            >
              <div className="mb-6">
              ...
              <Button variant="outline" onClick={handleGetStarted} className="w-full">
                Get Started Free
              </Button>
            </motion.div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative p-6 rounded-2xl bg-gradient-to-b from-primary/10 to-card border-2 border-primary/50 flex flex-col"
            >
              ...
              <div className="mb-6">
                ...
                <p className="text-sm text-muted-foreground mt-2">For serious traders</p>
              </div>
              ...
              <Button onClick={handleGetStarted} className="w-full bg-gradient-to-r from-primary to-profit hover:opacity-90">
                Upgrade to Pro
              </Button>
            </motion.div>
            ...
            >
              <div className="mb-6">
                ...
                <p className="text-sm text-muted-foreground mt-2">For trading teams</p>
              </div>
